...
(function(root, factory) {
  ...
  describe('Team', function() {
    it('should create an instance of Team', function() {
      ...
      //var instance = new Api.Team();
      //expect(instance).to.be.a(Api.Team);
    });
    ...
    it('should have the property countAthletes (base name: "count_athletes")', function() {
      // uncomment below and update the code to test the property countAthletes
      //var instance = new Api.Team();
      //expect(instance).to.be();
    });
