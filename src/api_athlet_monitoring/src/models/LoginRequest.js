 ...
 * @module models/LoginRequest
 * @version 1.0.0
 */
class LoginRequest {
    /**
     * Constructs a new <code>LoginRequest</code>.
     * @alias module:models/LoginRequest
     * @param email {String} 
     ...
     * @param {module:models/LoginRequest} obj Optional instance to populate.
     * @return {module:models/LoginRequest} The populated <code>LoginRequest</code> instance.
     */
